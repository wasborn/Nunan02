...
ks = LINETCR.LINE()
ks.login(token="EmzqcRBq7IcOUrzyLCPf.khw5oKeXkGNprT+dPTIyhW.RYojfWiLfx6InOw27rvsI71NY//HhLRMX0RjYqKZRZM=")
ks.loginResult()

kc = LINETCR.LINE()
kc.login(token="Emr2Vurv5MbVJBCstgO9.NLEdVUFE9zK89Wsdc4+xQq.7J5xt1VOfegPn01qfCODHgH5tRu672IZM/mecO3BL6c=")
kc.loginResult()

ka = LINETCR.LINE()
ka.login(token="EmxBEWwTLeAFzWy4YIx8.8dn1/XO+lm5j1UydamMhsa.Vy3Yg/C5iHr08ocQtjgfWvvZ2VovcPWDw0e8ClvDZfw=")
ka.loginResult()

print "login success"
reload(sys)
sys.setdefaultencoding('utf-8')
helpMessage ="""💓selfbot💓น้อง.ชิ
...
wait = {
    ...
    'timeline':False,
    'autoAdd':False,
    'message':"Thanks add 💓Love💓 http://line.me/ti/p/ShgslAPyYS  ",
    "lang":"JP",
