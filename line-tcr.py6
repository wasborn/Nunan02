...
cl = LINETCR.LINE()
cl.login(token="EmuhZwdh052rHwK9E2Vc.ugJ+9dMgaAs1/HYyDUOxda.r/RvRTc7UK23/onpfn1HYyoJqnxXKE/QVxoLJYkrVrM=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EmS1Hj6dGZ6cmtdcZItc.sZv3N17Hnvf3rV+iVgX3la.2643jQuYbz5C1dgZ9a7iDI0ViyP5gsXfiGEpydChXWg=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EmTDEIC1aJzqp8vzgbId.WhaXXUtVTTGNCzAQZKoahq.O1cq++v6eOrgINr9mlYuQlSP16WQ1tSiNggI3vbqGIs=")
kk.loginResult()

ks = LINETCR.LINE()
ks.login(token="EmKLtcKPfJWLMXdovCX0.J+CcBoFrJAH0a2V2NbmW0a.cawl3+YskNvEscQkqlJ6gdKF/8PdwQ2SxztsJOfESlM=")
ks.loginResult()

kc = LINETCR.LINE()
kc.login(token="Em6ssEpFOovGMKfvGs58.CvfDE0xmrO8VQJ0W/N/iMa.mV4cn4B3WMGsfqHkAafg9P5CHZ4uHgAaGHdjRtPxVvM=")
kc.loginResult()

ka = LINETCR.LINE()
ka.login(token="EmtPvm7HnK0Weu7C26f4.h+7LUlIDiBHqDaKNxldQza.iqP0myOWnxmAFR3pylds2HRyGhGsbDeE8EHWroMAq+Y=")
ka.loginResult()
...
wait = {
    ...
    'timeline':False,
    'autoAdd':False,
    'message':"Thanks add สวัดดีชาวโลก  http://line.me/ti/p/ShgslAPyYS  ",
    "lang":"JP",
    "comment":"Auto like สวัดดีชาวโลก  http://line.me/ti/p/ShgslAPyYS  ",
    "likeOn":False,
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
